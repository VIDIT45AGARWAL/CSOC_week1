    ...
    <>
      <div className='min-h-screen bg-neutral-100 dark:bg-neutral-900 relative transition-colors duration-200 isolate'>
        <div className='absolute inset-0 -z-10'>
          ...
          <div className='absolute inset-0 dark:block' style={{backgroundImage : 'radial-gradient(rgba(255,255,255,0.1) 1px, transparent 1px', backgroundSize: '20px 20px',}}>
          </div>
        </div>
        ...
        <a className='fixed top-15 lg:top-17 lg:right-4 right-3 w-9 h-9 lg:w-10 lg:h-10 flex justify-center items-center rounded-full bg-neutral-300 shadow-lg hover:bg-white transition-colors cursor-pointer z-10' href="https://github.com/VIDIT45AGARWAL/CSOC_week1">
